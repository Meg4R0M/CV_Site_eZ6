...
jQuery(document).ready(function () {
    ...
    jQuery('#personal-typed').typed({
        strings: ['Développeur web full-stack', 'Créateur de projets', 'Technicien informatique'],
        loop: true,
        typeSpeed: 30,
        backDelay: 2000,
        loopCount: false
    ...
    function mailchimpCallback(response) {
        ...
        if (response.result === 'success') {
            ...
            jQuery('.nesto-response').html('Veuillez vérifier votre e-mail pour compléter l\'abonnement');
        } else if (response.result === 'error') {
            jQuery('.nesto-response').html('Veuillez saisir une adresse e-mail non inscrite/valide');
        }
    }
    ...
    jQuery('#newsletter-form').ajaxChimp({
        ...
        url: 'http://ovh.us14.list-manage.com/subscribe/post?u=03c86d6f16fc24e25e68372f0&id=0a4bd1da34'
    });
...
jQuery(window).load(function () {
        ...
        if (!jQuery('body').hasClass('single-project')) {
            setTimeout(function () {
                notification = new NotificationFx({
                    ...
                    layout: 'growl',
                    effect: 'slide',
                    message: '<p>Bienvenue sur mon site CV, n\'hesitez pas à me contacter pour plus de renseignements.</p>'
                });
                notification.show();
            }, 1000);
        }
    ...
    Dribbble Feed
    ========================================================================== */
    jQuery.jribbble.getShotsByPlayerId('Meg4R0M', function (playerShots) {
        var html = [];
    ...
    jQuery('.tweetfeed .tweet').twittie({
        template: '<a href="http://twitter.com/ToosDL" title="Meg4R0M" target="_blank"><i class="fa fa-twitter"></i></a> {{tweet}}',
        count: 1,
        hideReplies: true
    });
